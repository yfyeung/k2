...
FsaVec FastCtcGraphs_Multi_Repeat(const Ragged<int32_t> &symbols, bool modified /*= false*/,
...
FsaVec FastCtcGraphs_1_Repeat(const Ragged<int32_t> &symbols, bool modified /*= false*/,
                 Array1<int32_t> *aux_labels /*= nullptr*/) {
  NVTX_RANGE(K2_FUNC);
  K2_CHECK_EQ(symbols.NumAxes(), 2);
  ContextPtr &c = symbols.Context();
...
FsaVec FastCtcGraphs(const Ragged<int32_t> &symbols, bool modified /*= false*/,
                 Array1<int32_t> *aux_labels /*= nullptr*/, const int max_repeat) {
  K2_CHECK_LE(1, max_repeat);
  if (1 == max_repeat) {
    return FastCtcGraphs_1_Repeat(symbols, modified, aux_labels);
  }
  return FastCtcGraphs_Multi_Repeat(symbols, modified, aux_labels, max_repeat - 1);
}
